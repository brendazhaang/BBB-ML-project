...
input_layer_size  = 1119; % 20x20 Input Images of Digits
...
% hyperparameter
##[lambda cv_acc AUC] = crossval(X_training, Y_training, initial_nn_params, input_layer_size, ...
...
t = 0.76
pred = predictNN(Theta1, Theta2, Theta3, X_training, t);
disp('Training Set: ');  
...
%fprintf('g mean: %f\n', sqrt(sp*se));
    ...
    %-------------test set-----------------
pred = predictNN(Theta1, Theta2, Theta3, X_test, t);
disp('Test Set: ');
