...
input_layer_size  = 72; % 20x20 Input Images of Digits
...
load('cdk_select_test.mat'); %74 x 72

[m, n] = size(cdk_select_train); %m = 7162, n = 1119
[a, b] = size(cdk_select_test);     %a = 74, b = 119
...
% hyperparameter
[lambda cv_acc AUC] = crossval(cdk_select_train, Y_training, initial_nn_params, input_layer_size, ...
...
costFunction = @(p) nnCostFunction(p, ...
                                   input_layer_size, ...
                                   hidden_layer_size, ...
                                   num_labels, cdk_select_train, Y_training, lambda);
...
t = 0.76;
pred = predictNN(Theta1, Theta2, Theta3, cdk_select_train, t);
disp('Training Set: ');  
...
%-------------test set-----------------
pred = predictNN(Theta1, Theta2, Theta3, cdk_select_test, t);
disp('Test Set: ');
