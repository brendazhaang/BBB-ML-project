...
function [lambda acc AUC] = crossval2(X, Y, initial_nn_params, input_layer_size, ...
                  hidden_layer_size, num_labels)
t = 0.76;
L_vec = [0.01 0.03 0.06 0.1 0.3 0.5 0.6 0.8 1]';
...
for i = 1 : length(L_vec)
  ...
  pred = predictNN2(Theta1, Theta2, Theta3, Theta4, Theta5, X3, t);
  ...
  pred = predictNN2(Theta1, Theta2, Theta3, Theta4, Theta5, X2, t);
  ...
  pred = predictNN2(Theta1, Theta2, Theta3, Theta4, Theta5, X1, t);
